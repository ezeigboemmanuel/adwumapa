        ...
        <div className="md:w-[544px] h-[304px] gap-6 flex flex-col items-center mt-[5rem] lg:mt-[-9rem]">
          ...
          <div>
            ...
            <p className="font-montserrat font-normal text-[14px] lg:text-[18px] text-center text-[#0a0f29]">
              Find top African tech talents, hire anonymously, and pay <br className="hidden md:inline-block" />{" "}
              securely in crypto.
            </p>
          </div>

          <div className="h-[48px] gap-3 md:gap-6 flex justify-between items-center">
            <Link
              className="lg:h-[48px] px-4 md:px-6 py-3 gap-2 rounded-tl-[4px] rounded-tr-none rounded-br-none rounded-bl-none bg-[#2F66F6] font-montserrat font-medium text-[14px] lg:text-[16px] leading-6 text-nowrap text-[#ffffff] text-center"
              href="/waitlist/client"
            >
              Join Waitlist as a client
            </Link>
            <a
              className="lg:h-[48px] px-4 md:px-6 py-3 gap-2 rounded-tl-[4px] rounded-tr-none rounded-br-none rounded-bl-none bg-[#696F8C] border border-solid border-[#D7D9E4] font-montserrat text-[14px] lg:text-base font-medium text-center leading-6 text-nowrap text-[#ffffff]"
